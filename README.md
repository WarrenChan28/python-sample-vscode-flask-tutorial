[![Build Status](https://dev.azure.com/WarrenChan888/pipeline-demo/_apis/build/status/WarrenChan28.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/WarrenChan888/pipeline-demo/_build/latest?definitionId=1&branchName=master)
